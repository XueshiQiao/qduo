...
<img src="screenshots/popup-ring-zh.jpg" width="800" alt="QDuo 的环形菜单，「文件与网页」分组展开成第二圈" />

## ✨ 功能

### 🫧 就在你正在用的地方弹出

- **两种样式**：选区上方的胶囊条，或者围着光标的一圈圆环（经典 / Liquid Glass 两种外观）。**分组**在圆环上会展开成第二圈，在胶囊条上会展开成下拉菜单。
